      ...
      <div className={footerStyles.mainContainer}>
        <div className={footerStyles.gridContainer}>
          <div className={footerStyles.brandContainer}>
            <div className={footerStyles.brandLogoContainer}>
              ...
              <h2 style={{fontFamily:"Monton, cursive"}}className={footerStyles.brandTitle}>
                Kino<span className={footerStyles.brandTitleWhite}>Spot</span>
              </h2>
            </div>
          ...
          <div>
            ...
            <ul className={footerStyles.contactList}>
              <li className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>contact@kinospotservices.com</span>
              </li>
              <li className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconContainer}>
              ...
              <li className={footerStyles.contactItem}>
                ...
                <span className={footerStyles.contactText}>Mumbai, India</span>
              </li>
            </ul>
          </div>
        ...
        <div className={footerStyles.bottomBar}>
          <div className={footerStyles.designedBy}>
            <span className={footerStyles.designedByText}>Designed by Harshvardhan</span>
          </div>
