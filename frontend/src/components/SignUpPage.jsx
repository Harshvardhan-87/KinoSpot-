...
const SignUpPage = () => {
   ...
   try {
      const payload = {
         fullname: formData.fullName.trim(), // lowercase N
      ...
      <div className={signUpStyles.cardContent}>
         ...
         <form onSubmit={handleSubmit} className={signUpStyles.form}>
            <div className={signUpStyles.formGrid}>
               <div>
                  ...
                  <div className={signUpStyles.inputContainer}>
                     ...
                     value={formData.fullName} onChange={handleChange} className={`${signUpStyles.input.base}  ${
                  ...
                  <div className={signUpStyles.inputContainer}>
                     ...
                     type="email"
                      id="email"
                       name="email"
                        required
                     value={formData.email} onChange={handleChange} className={`${signUpStyles.input.base}  ${
                        errors.email
                  ...
                  <div className={signUpStyles.inputContainer}>
                     ...
                     type="tel"
                      id="phone"
                       name="phone"
                        required
                     value={formData.phone} onChange={handleChange} className={`${signUpStyles.input.base}  ${
                        errors.phone
                         ? signUpStyles.input.error
                         : signUpStyles.input.normal
                     } ${signUpStyles.inputWithIcon}`}
                  ...
                  <div className={signUpStyles.inputContainer}>
                     ...
                     type="date"
                      id="birthDate"
                       name="birthDate"
                        required
                     value={formData.birthDate} onChange={handleChange} className={`${signUpStyles.input.base}  ${
                        errors.birthDate
                         ? signUpStyles.input.error
                         : signUpStyles.input.normal
                     } ${signUpStyles.inputWithIcon}`}
                  ...
                  <div className={signUpStyles.inputContainer}>
                     ...
                     type={showPassword ? "text" : "password"}
                      id="password"
                       name="password"
                        required
                     value={formData.password} onChange={handleChange} className={`${signUpStyles.input.base}  ${
                        errors.password
                         ? signUpStyles.input.error
                         : signUpStyles.input.normal
                     } ${signUpStyles.inputWithToggle}`}
                     placeholder="Create astrong password"
                     />
                     <div className={signUpStyles.inputIcon}>
                        <Lock size={18}/>
                     </div>
            ...
            <div className={signUpStyles.submitContainer}>
               <button type="submit" disabled={isLoading} className={`${signUpStyles.submitButton.base} ${
