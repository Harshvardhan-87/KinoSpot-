...
const DashboardPage = () => {
   ...
   useEffect(() => {
    ...
    //this function fetches the number and booking realted things from the backend.
         ...
         <section className={styles3.summaryGrid}>
            ...
            <div className={styles3.summaryCard}>
               <div className={styles3.summaryCardInner}>
                  ...
                  <div className={styles3.summaryBadge}>Paid summary</div>
               </div>
